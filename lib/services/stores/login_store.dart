...
import 'package:pringnome/ui/pages/auth/otp_page.dart';
    ...
    await _auth.verifyPhoneNumber(
        ...
        verificationFailed: (AuthException authException) {
          ...
          loginScaffoldKey.currentState.showSnackBar(SnackBar(
            behavior: SnackBarBehavior.floating,
            backgroundColor: Colors.red,
            content: Text(authException.message, style: TextStyle(color: Colors.white),),
          ));
...
//  @action
//  Future<void> confirmPassword(BuildContext context, String userID, String Password) async {
//
//  }
